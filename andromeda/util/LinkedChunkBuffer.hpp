#ifndef ANM2DR_UTIL_LINKEDCHUNKBUFFER
#define ANM2DR_UTIL_LINKEDCHUNKBUFFER
#include <iostream>
#include <malloc.h>
#include <string.h>
        ...
        public:
            ...
            void put(E *elements,int length)
            {
                ...
                for(int i=0;i<length;++i)
                {
                    ...
                    if(relative_pos==0)
                    {
                        if(last_chunk_for_pos==last_chunk)alloc_chunk(1);
                        if(data_size==0)
                            last_chunk_for_pos=first_chunk;
                        else last_chunk_for_pos=last_chunk_for_pos->next;
                    }
...
#endif // ANM2DR_UTIL_LINKEDCHUNKBUFFER
