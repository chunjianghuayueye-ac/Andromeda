...
namespace andromeda {
	namespace media {
		...
		{
		public:
			andromeda::image::RasterImage *img;
			int last_frame_count;

			VideoFrameInfo(andromeda::image::RasterImage& image);
			VideoFrameInfo(andromeda::image::RasterImage& image,int lfc);
		};
		...
		public:
			...
			void inputFrame(andromeda::image::RasterImage& img,int last_frame_count);
			...
			static void loadYUV444PDataFromRasterImageToFrame(andromeda::image::RasterImage &img,AVFrame *frame_);
		};
	}
}
